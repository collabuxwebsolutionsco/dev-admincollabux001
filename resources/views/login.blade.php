...
<html lang="en-us">
    ...
    <body id="login" class="animated fadeInDown">
        ...
        <header id="header">
            ...
            <span id="login-header-space"> <span class="hidden-mobile">Need an account?</span> <a href="register.html" class="btn btn-danger">Request Account</a> </span>
  ...
  <div id="main" role="main">
      ...
      <div id="content" class="container">
        ...
        <div class="row">
          <div class="col-xs-4 col-sm-4 col-md-5 col-lg-4"></div>        
    ...
    <script src="smart-admin/js/plugin/pace/pace.min.js"></script>
