    ...
    <div id="main" role="main">
      ...
      <div id="ribbon">
        ...
        <section class="col-sm-6 col-md-6 col-lg-6 header-button">
          <a class="btn btn-primary" href="javascript:void(0);"><b>Approve</b></a>&nbsp;<a class="btn btn-primary" href="javascript:void(0);"><b>Decline</b></a> 
        </section>        </div>
                  ...
                  <div class="widget-toolbar">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu pull-right">
                        ...
                        <li>
                          <a href="javascript:void(0);">Declined</a>
                        </li>                        
                      </ul>
                    </div>
                  </div>                  
                    ...
                    <table id="datatable_tabletools" class="table table-bordered table-striped table-condensed table-hover  has-tickbox">
                      <thead>
                        <tr>
                          ...
                          <th>Name</th>
                          <th>Date</th>                          
                          <th><span rel="tooltip" data-placement="bottom" data-original-title="Remaining Leave Credits">Credits</span></th>
                          <th>Supervisor</th>
                          <th>Status</th>
                          <th>Request Date</th>
