    ...
    <div id="main" role="main">
      ...
      <div id="ribbon">
        ...
        <section class="col-sm-6 col-md-6 col-lg-6 header-button">
          <a class="btn btn-success" href="javascript:void(0);" data-toggle="modal" data-target="#myModal"><b>Add Ticket</b></a> <a class="btn btn-primary" href="javascript:void(0);"><b>Archive Selected</b></a> 
        </section>        </div>
            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
              ...
              <div class="jarviswidget jarviswidget-color-red" id="wid-id-3" data-widget-editbutton="false">
                ...
                <header class="section-header">                  
                  ...
                  <h2>Ticket List > Project Name</h2>                  
                  <div class="widget-toolbar">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu pull-right">
                        ...
                        <li>
                          <a href="javascript:void(0);">Updating forms</a>
                        </li>                                                                      
                      </ul>
                    </div>
                    Status:
